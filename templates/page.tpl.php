  ...
  <!-- container -->
	...
	<div class="row">
	  <div id="main-content-wrap" class="ten columns">
		<div id="header-wrap" class="row">
		  <div id="logoMenu" class="two columns">
			...
			<div id="nav-wrap">
			  ...
			  <?php endif; ?>
			  <!-- <ul>
				<li><a href="#">Login</a></li><!-- Switch to Logout once logged in 
				<li><a href="#">Join</a></li><!-- Switch to Add  
		  ...
		  <div id="topBar" class="ten columns">
		  	<?php if ($topBar): ?>
			  <?php print $topBar; ?>
			<?php endif; ?>
		  </div><!-- end #topBar / .row -->	
		...
		<div class="row">
		  <div id="sidebar-first" class="two columns">
			...
			<?php else: ?>
			 ...
			 <!-- - Info about how far you rode -->
			  ...
			  <?php  Material above commented out by Miles */ ?>
		  ...
		  <div id="content-wrap" class="ten columns">
			<div class="row">
			<?php if ($is_front || $node->type == "track"): ?>
			  <div id="map-wrap" class="twelve columns">
			<?php else: ?>
			  <div id="inner-content-wrap" class="twelve columns">
            <?php endif; ?>
			...
			<!--<?php if (!$node->type == "track"): ?>  
			  ...
			  </div><!-- end #map-wrap or inner-content-wrap -->
			</div><!-- end .row -->
			<div class="row">
			  <div id="footer-wrap" class="twelve columns">
	  ...
	  <div id="main-sidebar-wrap" class="two columns">
		...
		<?php endif; ?>
		<?php if ($node->type == "track"): ?>
          <div><a href='#' class='track-switcher'>View Comments</a><div>
		<?php endif; ?>
